        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div>
            ...
            <p className="text-gray-400">
              ...
              officia perspiciatis velit, aspernatur quas eius temporibus
              molestias tenetur veniam cupiditate magni. Repellendus expedita
              architecto ut autem, sed rerum porro amet.
            </p>
          </div>
          <div>
            <div className="flex gap-20">
              ...
              <div className="flex-1 md:flex-none">
                ...
                <ul className="list-item space-y-5 text-gray-400">
                  ...
                  <li>
                    <Link href="/payment-methods"> Payment Method</Link>
                  </li>
                  <li>
            ...
            <form action="" className="mt-5">
              <div className="mb-5">
                <input
                  type="text"
                  name="email"
                  className="w-full p3-rounder-sm bg-white placehoder="
